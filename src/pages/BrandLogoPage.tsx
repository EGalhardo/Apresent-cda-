...
export default function BrandLogoPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-12">
      ...
      >
        <div className="bg-white rounded-3xl border border-slate-200/90 p-8 sm:p-12 md:p-16 flex flex-col items-center justify-center min-h-[500px] sm:min-h-[600px] relative overflow-hidden">
          ...
          <div className="w-full flex items-center justify-center p-4 sm:p-8">
            <img
              ...
              className="max-w-full max-h-[500px] sm:max-h-[580px] w-auto h-auto object-contain transition-transform duration-300"
            />
          </div>
        </div>
      </motion.div>
